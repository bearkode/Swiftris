...
class BlockTests: XCTestCase {
    ...
    func testValueAtPosition() {
        ...
        XCTAssertTrue(block.value(at: Point(x: 5, y: 6)) == nil, "")
        ...
        XCTAssertTrue(block.value(at: Point(x: 6, y: 7)) == nil, "")
        XCTAssertTrue(block.value(at: Point(x: 7, y: 7)) == nil, "")
        XCTAssertTrue(block.value(at: Point(x: 8, y: 5)) == nil, "")
        XCTAssertTrue(block.value(at: Point(x: 8, y: 6)) == nil, "")
        XCTAssertTrue(block.value(at: Point(x: 10, y: 10)) == nil, "")
    }

    let grid0 = Grid(size: Size(width: 4, height: 4), array: [0, 3, 3, 0, 0, 0, 3, 0, 0, 0, 3, 0].map(conv))
